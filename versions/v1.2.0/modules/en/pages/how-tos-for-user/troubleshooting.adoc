= Troubleshooting
:description: Troubleshoot K3K virtual clusters by checking logs, fixing storage class issues, resolving image pull errors, adjusting node selectors, and increasing inotify
...
How you reach etcd depends on whether the virtual cluster's control plane is exposed outside the host cluster. Pick the approach that matches your setup:

[tabs]
====
Local Machine (Exposed Clusters)::
+
--
...
Ephemeral Debug Container (Private Clusters)::
+
--

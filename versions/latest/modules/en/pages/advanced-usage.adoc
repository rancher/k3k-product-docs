...
NOTE: Most of these customization options can also be configured using the `k3kcli` tool. Refer to the xref:/cli/k3kcli.adoc[k3kcli] documentation for more details.
...
You can check the xref:/cli/k3kcli.adoc[k3kcli documentation] for the full specs.

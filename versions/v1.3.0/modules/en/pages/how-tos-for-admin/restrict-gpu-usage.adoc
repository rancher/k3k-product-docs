...
:description: Create a VirtualClusterPolicy in a YAML file, apply it to your cluster, annotate the tenants namespace to generate a resource quota, and use the quota command
